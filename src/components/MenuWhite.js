    ...
    <header>
      <div className="lg:flex hidden items-center justify-between font-poppins text-black-100 h-20">
        ...
        <nav>
          <ul className="text-md text-white-100 flex justify-center gap-8 items-center">
            ...
            <li><Link to="/about" className="hover:text-seagreen-100">About</Link></li>
            <li><Link to="/destination" className="hover:text-seagreen-100">Destination</Link></li>
            <li><Link to="/contact" className="hover:text-seagreen-100">Services</Link></li>
            <li><Link to="/blog" className="hover:text-seagreen-100">Blog</Link></li>
          </ul>
        </nav>
      ...
      <div className="lg:hidden flex items-center justify-between pt-5 font-nutino-sans">
        ...
        <button onClick={() => setShow(!show)} className="nav cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-white-100">
